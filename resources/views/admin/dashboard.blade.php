            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
              <div class="card card-stats">
                <div class="card-header card-header-danger card-header-icon">
                  <div class="card-icon">
                    <h2>Pending Crediting: {{ count($pendings)  }}</h2>   
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
              <div class="card card-stats">
                <div class="card-header card-header-primary card-header-icon">
                  <div class="card-icon">
                    <h2>Withdrawal Request: {{ count($withdraws)  }}</h2>   
                  </div>
                </div>
              </div>
            </div>
              ...
              overflow-y: scroll;
                            ...
                            <tbody>
                             @foreach ($users as $user)
                              <tr>
                                ...
                                <td><a href="update/{{ $user->id }}" class="btn  btn-info">edit/update</a></td>
                              </tr>
                              @endforeach
                  ...
                  <div class="row" style="width:100%;">
                    <div class="col-lg-12 col-md-12">
                      <div class="card" >
                        <div class="card-header card-header-warning">
                          <h4 class="card-title">Asking Withdrawals</h4>
                          <p class="card-category">this are users that are asking for Withdrawals</p>
                        </div>
                        <div class="card-body table-responsive">
                            ...
                            <tbody>
                             @foreach ($withdraws as $withdraw)
                              <tr>
                                ...
                                <td>{{ DB::table('users')->where('id',$withdraw->user_id)->value('name') }}</td>
                                <td>{{ DB::table('users')->where('id',$withdraw->user_id)->value('account_balance') }}</td>
                                <td>{{ $withdraw->amount }}</td>
                                <td>{{ $withdraw->via }}</td>
                                <form action="message/{{ $withdraw->user_id}}" method="post">@csrf
                                <td><input required type="text" name="message" id=""></td>
                                <td><button type="submit"  class="btn  btn-outline-primary">send</button></td>
                                </form>
                              </tr>
                              @endforeach
